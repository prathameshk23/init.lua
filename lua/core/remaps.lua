...
-- Rust
-- vim.api.nvim_set_keymap("n", "<leader>rr", ":vsp | term cargo run<CR>", {})
-- vim.api.nvim_set_keymap("n", "<leader>rb", ":vsp | term cargo build<CR>", {})
-- vim.api.nvim_set_keymap("n", "<leader>rt", ":vsp | term cargo test<CR>", {})
-- REST API
vim.api.nvim_set_keymap("n", "<leader>rr", ":Rest run<CR>", {})
vim.api.nvim_set_keymap("n", "<leader>rl", ":Rest run last<CR>", {})
-- Flutter
